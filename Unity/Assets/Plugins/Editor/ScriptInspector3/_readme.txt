...
This package has been exported from Unity 4.0.0 to make use of the new Font Importer features. Other than that, there's no other reason why Si3 wouldn't run in Unity 3.5! If you want to use Si3 with Unity 3.5 simpy copy the Assets/Plugins/Editor/ScriptInspector3 folder manually from a Unity 4+ project to your Unity 3.5 project.
...
1. The Old Si2 Description -- to be updated for Si3 --
